...
module.exports = function addCustomResource(domainName, basePath, deploymentId, stageName) {
  ...
  if (stageName.from.type === 'AWS::ApiGateway::Stage'){
    this.template.Resources.CustomApiGatewayBasePathMapping.DependsOn.push(stageName.from.key);
  }
